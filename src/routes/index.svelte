...
<div class="bg-slate-900 min-h-screen marshmallow">
			...
			<svg
				...
				><defs
					...
					>
						...
						>
							<feDistantLight azimuth="3" elevation="28" />
						</feSpecularLighting>
					</filter></defs
				><rect width="1700" height="700" fill="#0f172a" /><rect
					width="1700"
					height="700"
					fill="hsl(0, 0%, 100%)"
	...
	<div class="w-full relative">
		<svg
			xmlns="http://www.w3.org/2000/svg"
			class="h-24 w-24 sm:h-60 sm:w-60 m-auto"
			fill="none"
			viewBox="0 0 24 24"
			stroke-width="1.5"
...
<style>
	.animate-glow {
		animation: glow 7s cubic-bezier(0.4, 0, 0.6, 1) infinite;
	}
	.animate-glow2 {
